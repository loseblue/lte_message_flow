...
== UE synchronize with the eNB ==
eNB -> UE1: Primary Synchronization Signal (PSS)
eNB -> UE1: Secondary Synchronization Signal (SSS)

== UE download the system information ==
eNB -> UE1: Master Information Block (MIB)
eNB -> UE1: PDCCH DCI Format 1A
note right of UE1: SI-RNTI
eNB -> UE1: System Information Block 2 (SIB2)
...
rnote over UE1 
	Select Preamble 1
endrnote
UE1 -> eNB: RACH RA Preamble 1
note right of UE1: RA-RNTI 1 

rnote over UE2
	Select Preamble 1
endrnote
UE2 ->x eNB: RACH RA Preamble 1
note right of UE2: RA-RNTI 1 

rnote over UE3
	Select Preamble 3
endrnote
UE3 -> eNB: RACH RA Preamble 3
note right of UE3: RA-RNTI 1 
@enduml
---------------------------------------------------------------------
...
title LTE Attach and Default Bearer Setup Flow
